...
def transcribe_audio(
    ...
    # Set condition_on_previous_text=False to prevent early termination at 28-30s boundaries
    # Set vad_filter=False so background music or sound effects don't truncate speech
    try:
